...
import { updateFormattedAmount, parseFormattedAmount } from "../utils/utils";
import { Asset } from "@/features/assets/types/types";
import { PresetAmountOption, SendTransaction } from "../types/types";
...
const sendSlice = createSlice({
  ...
  reducers: {
    ...
    unmountOverlays: (state, action) => {
      ...
      state.transaction.assetId = initialState.transaction.assetId;
    },
