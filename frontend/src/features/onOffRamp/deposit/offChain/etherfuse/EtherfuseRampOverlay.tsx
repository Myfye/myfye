      ...
      >
        ...
        >
          <section
            ...
            `}
          >
            <h1 className="heading-x-large">Deposit Instructions</h1>
            <p
              className="caption"
              css={css`
            ...
            <p
              ...
              `}
            >
              Send the exact amount to the CLABE number below to complete your
              deposit.
            </p>
          </section>
          <section
        ...
        >
          ...
          >
            ...
            <div
              ...
              `}
            >
              <BankIcon size={20} color="var(--color-primary)" />
              <span
                css={css`
                  font-size: 14px;
                  color: var(--color-text-primary);
          ...
          >
            ...
            <div
              ...
              `}
            >
              <CreditCardIcon size={20} color="var(--color-primary)" />
              <span
                css={css`
                  font-size: 14px;
                  color: var(--color-text-primary);
