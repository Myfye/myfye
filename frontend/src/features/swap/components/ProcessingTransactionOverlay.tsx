...
import { toggleOverlay, unmount } from "../stores/swapSlice";
...
import { SwapTransactionStatus } from "../types/types";
...
import { selectAsset } from "../../assets/stores/assetsSlice";
...
const getSubtitle = (
  ...
  switch (status) {
    ...
    case "fail": {
      ...
      const isSellingSolana = assetId === "sol" || assetId === "w_sol";
...
const ProcessingTransactionOverlay = () => {
  ...
  const asset = useAppSelector((state) =>
    transaction.buy.assetId ? selectAsset(state, transaction.buy.assetId) : null
  );
