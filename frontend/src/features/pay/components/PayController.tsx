...
import AssetIcon from "../../assets/components/AssetIcon";
import {
  toggleOverlay,
  updateAmount,
  updatePresetAmount,
} from "../stores/paySlice";
import { selectAssetWithBalance } from "../../assets/stores/assetsSlice";
import { Asset } from "../../assets/types/types";
import { PresetAmountOption } from "../types/pay.types";
import { updateFormattedGhostAmount } from "../utils/utils";
...
import AssetSelectButton from "../../assets/components/AssetSelectButton";
...
const PayController = () => {
  ...
  const asset = useSelector((state: RootState) =>
    assetId ? selectAssetWithBalance(state, assetId) : null
  );
