...
import { toggleOverlay, updateAssetId, updateAmount } from "../stores/paySlice";
import { Asset, AssetSection } from "../../assets/types/types";
import {
...
const PaySelectAssetOverlay = ({ zIndex = 1000 }) => {
  ...
  const asset = useSelector((state: RootState) =>
    state.pay.transaction.assetId
      ? selectAssetWithBalance(state, state.pay.transaction.assetId)
      : null
  );
