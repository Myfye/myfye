...
import { getTokenProgramAddressFromMintAddress } from "../features/assets/stores/assetsSlice";
...
async function ensureTokenAccount(
  ...
  const programId =
    getTokenProgramAddressFromMintAddress(mintAddress as string) ||
  ...
  const receiverParsedTokenAccounts =
    await connection.getParsedTokenAccountsByOwner(userPublicKey, {
