...
import { getTokenProgramAddressFromMintAddress } from '../features/assets/assetsSlice';
...
async function ensureTokenAccount(userPublicKeyString: String, mintAddress: String) {
    ...
    const programId = getTokenProgramAddressFromMintAddress(mintAddress as string) || 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA';
